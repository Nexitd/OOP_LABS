...
Date Date::operator-(int _day) {            ///peregruzka operatora - dlya zarabotnoi plati
	Date temp;
	temp.day = day - _day;
	temp.month = month;
	temp.year = year;
...
int main() {
    ...
    cout<<"______________________________________________________"<<endl;
	rezult = start - 31;
	cout << "Data dlya vichesleniya zarplati (Date-Int): " << rezult << endl;
    cout<<"______________________________________________________"<<endl;
	rezult = rezult++;
	cout << "Perehod k sleduyushey date (date++): " << rezult << endl;
    cout<<"______________________________________________________"<<endl;
	rezult = rezult--;
	cout << "Perehod k predidushey date (Date--): " << rezult << endl;
	return 0;
}
